  ...
  data() {
    return {
      ...
      performance: [
        {
          icon: 'graphics',
          info: [{ title: '显存类型', detail: 'memoryType' }, { title: '显卡芯片', detail: 'chip' }],
        },
        {
          icon: 'heartbeat',
          info: [{ title: '显存频率', detail: 'memoryFrequency' }, { title: '核心频率', detail: 'codeFrequency' }],
        },
        {
          icon: 'memoryCard',
          info: [{ title: '显存容量', detail: 'memoryCapacity' }, { title: '显存位宽', detail: 'memoryBandwidth' }],
        },
        {
          icon: 'power',
          info: [{ title: '电源接口', detail: 'powerInterface' }],
        },
      ],
    };
  },
