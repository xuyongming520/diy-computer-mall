  ...
  data() {
    return {
      ...
      performance: [
        {
          icon: 'display',
          info: [{ title: '产品类型', detail: 'productType' }, { title: '产品定位', detail: 'positioning' }],
        },
        {
          icon: 'size',
          info: [{ title: '屏幕尺寸', detail: 'size' }, { title: '面板类型', detail: 'panelType' }],
        },
        {
          icon: 'eyes',
          info: [{ title: '最佳分辨率', detail: 'optimalResolution' }, { title: '可视角度', detail: 'visibleAngle' }],
        },
        {
          icon: 'USB',
          info: [{ title: '视频接口', detail: 'videoInterface' }, { title: '其他接口', detail: 'otherInterface' }],
        },
      ],
    };
  },
