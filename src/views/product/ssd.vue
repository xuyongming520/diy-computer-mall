  ...
  data() {
    return {
      ...
      performance: [
        {
          icon: 'disk',
          info: [{ title: '存储容量', detail: 'capacity' }, { title: '硬盘尺寸', detail: 'architecture' }],
        },
        {
          icon: 'USB',
          info: [{ title: '接口类型', detail: 'interfaceType' }, { title: '缓存', detail: 'cache' }],
        },
        {
          icon: 'dashboard',
          info: [{ title: '读取速度', detail: 'rwSpeed' }, { title: '写入速度', detail: 'writeSpeed' }],
        },
        {
          icon: 'clock',
          info: [{ title: '平均无故障时间', detail: 'troubleFree' }],
        },
      ],
    };
  },
