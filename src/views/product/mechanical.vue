  ...
  data() {
    return {
      ...
      performance: [
        {
          icon: 'disk',
          info: [{ title: '适用类型', detail: 'appropriateType' }, { title: '硬盘尺寸', detail: 'size' }],
        },
        {
          icon: 'pieChart',
          info: [{ title: '硬盘容量', detail: 'capacity' }, { title: '单碟容量', detail: 'singleCapacity' }],
        },
        {
          icon: 'dashboard',
          info: [{ title: '缓存', detail: 'cache' }, { title: '转速', detail: 'rotatingSpeed' }],
        },
        {
          icon: 'USB',
          info: [{ title: '接口类型', detail: 'interfaceType' }, { title: '接口速率', detail: 'interfaceSpeed' }],
        },
      ],
    };
  },
