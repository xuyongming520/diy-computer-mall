  ...
  data() {
    return {
      ...
      performance: [
        {
          icon: 'cpu',
          info: [{ title: '主芯片组', detail: 'series' }, { title: '音频芯片', detail: 'audioChip' }],
        },
        {
          icon: 'ram',
          info: [{ title: '内存类型', detail: 'ramType' }, { title: '最大内存容量', detail: 'maxRam' }],
        },
        {
          icon: 'board',
          info: [{ title: '主板板型', detail: 'type' }, { title: '外形尺寸', detail: 'shape' }],
        },
        {
          icon: 'power',
          info: [{ title: '电源插口', detail: 'power' }],
        },
      ],
    };
  },
